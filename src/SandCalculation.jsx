...
export default function SandCalculation() {
  const [workType, setWorkType] = useState("standalone");
  ...
  const [rateUnit, setRateUnit] = useState("per_tonne");
  ...
  const [standaloneLength, setStandaloneLength] =
    useState("");

  const [standaloneWidth, setStandaloneWidth] =
    useState("");

  const [standaloneDepth, setStandaloneDepth] =
    useState("");

  const [standaloneLengthUnit, setStandaloneLengthUnit] =
    useState("ft");

  const [standaloneWidthUnit, setStandaloneWidthUnit] =
    useState("ft");

  const [standaloneDepthUnit, setStandaloneDepthUnit] =
    useState("inch");
  ...
  const [rccLengthUnit, setRccLengthUnit] =
    useState("ft");

  const [rccWidthUnit, setRccWidthUnit] =
    useState("ft");

  const [rccDepthUnit, setRccDepthUnit] =
    useState("inch");

  const [rccCementParts, setRccCementParts] =
    useState("1");

  const [rccSandParts, setRccSandParts] =
    useState("2");

  const [rccAggregateParts, setRccAggregateParts] =
    useState("4");
  ...
  const [brickLengthUnit, setBrickLengthUnit] =
    useState("mm");

  const [brickWidthUnit, setBrickWidthUnit] =
    useState("mm");

  const [brickHeightUnit, setBrickHeightUnit] =
    useState("mm");

  const [brickMortar, setBrickMortar] =
    useState("10");

  const [masonryCementParts, setMasonryCementParts] =
    useState("1");

  const [masonrySandParts, setMasonrySandParts] =
    useState("6");
  ...
  const [plasterArea, setPlasterArea] =
    useState("");

  const [plasterAreaUnit, setPlasterAreaUnit] =
    useState("sqft");

  const [plasterThickness, setPlasterThickness] =
    useState("12");

  const [plasterThicknessUnit, setPlasterThicknessUnit] =
    useState("mm");

  const [plasterCementParts, setPlasterCementParts] =
    useState("1");

  const [plasterSandParts, setPlasterSandParts] =
    useState("4");
  ...
  const [screedArea, setScreedArea] =
    useState("");

  const [screedAreaUnit, setScreedAreaUnit] =
    useState("sqft");

  const [screedThickness, setScreedThickness] =
    useState("25");

  const [screedThicknessUnit, setScreedThicknessUnit] =
    useState("mm");

  const [screedCementParts, setScreedCementParts] =
    useState("1");

  const [screedSandParts, setScreedSandParts] =
    useState("4");
  ...
  const [tileArea, setTileArea] =
    useState("");

  const [tileAreaUnit, setTileAreaUnit] =
    useState("sqft");

  const [tileThickness, setTileThickness] =
    useState("20");

  const [tileThicknessUnit, setTileThicknessUnit] =
    useState("mm");

  const [tileCementParts, setTileCementParts] =
    useState("1");

  const [tileSandParts, setTileSandParts] =
    useState("4");
  ...
  const calculation = useMemo(() => {
    ...
    if (workType === "standalone") {
      const length = lengthToFeet(
        standaloneLength,
        standaloneLengthUnit
      );
      ...
      // Standalone sand does not require
      // a dry volume conversion factor.
      dryVolumeFt3 = wetVolumeFt3;

      sandVolumeFt3 = wetVolumeFt3;
    }
      ...
      <main className="mx-auto max-w-6xl px-6 py-10">
        ...
        <div>
          ...
          <p className="mt-3 text-gray-600">
            ...
            will use the appropriate sand calculation
        ...
        <section className="mt-8 rounded-2xl border bg-white p-6 shadow-sm">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Sand requirements change according to the
        ...
        {workType === "standalone" && (
          <section className="mt-8 rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Calculate sand directly from length,
              width and depth.
            </p>
            ...
            <div className="mt-6 grid gap-5 md:grid-cols-3">
              ...
              <InputWithUnit
                label="Length"
                value={standaloneLength}
                onChange={setStandaloneLength}
                unit={standaloneLengthUnit}
                onUnitChange={
                  setStandaloneLengthUnit
                }
              ...
              <InputWithUnit
                label="Width"
                value={standaloneWidth}
                onChange={setStandaloneWidth}
                unit={standaloneWidthUnit}
                onUnitChange={
                  setStandaloneWidthUnit
                }
              ...
              <InputWithUnit
                label="Depth"
                value={standaloneDepth}
                onChange={setStandaloneDepth}
                unit={standaloneDepthUnit}
                onUnitChange={
                  setStandaloneDepthUnit
                }
        ...
        {workType === "rcc" && (
          <section className="mt-8 rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Calculate sand from concrete volume and
        ...
        {workType === "brick_masonry" && (
          <section className="mt-8 rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Calculate sand from the mortar volume
              between the bricks.
            </p>
        ...
        {workType === "plaster" && (
          <section className="mt-8 rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Calculate sand according to plaster area,
        ...
        {workType === "floor_screed" && (
          <section className="mt-8 rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Calculate sand from floor area, screed
        ...
        {workType === "tile_bedding" && (
          <section className="mt-8 rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Calculate sand used in the cement-sand
        ...
        <section className="mt-8 rounded-2xl border bg-white p-6 shadow-sm">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Density is used to convert sand volume
            into weight.
          </p>
          ...
          <div className="mt-4 rounded-xl bg-blue-50 p-4 text-sm text-blue-800">
            ...
            <strong>Reference density:</strong>{" "}
            1600 kg/m³ is used as the default
            approximate sand density.
        ...
        <section className="mt-8 rounded-2xl border bg-white p-6 shadow-sm">
          ...
          <div className="mt-6 rounded-xl bg-gray-50 p-5">
            ...
            <div className="space-y-4">
              ...
              <ResultRow
                label="Wet Volume"
                value={`${calculation.wetVolumeFt3.toFixed(
                  4
                )} cu ft`}
              />
              ...
              <ResultRow
                label="Dry Volume"
                value={`${calculation.dryVolumeFt3.toFixed(
                  4
                )} cu ft`}
              />
              ...
              <ResultRow
                label="Sand Volume"
                value={`${calculation.sandVolumeFt3.toFixed(
                  5
                )} cu ft`}
              />
              ...
              <ResultRow
                label="Sand Volume"
                value={`${calculation.sandVolumeM3.toFixed(
                  5
                )} m³`}
              />
              ...
              <ResultRow
                label="Sand Density"
                value={`${calculation.densityKgM3.toFixed(
                  2
                )} kg/m³`}
              />

              <ResultRow
                label="Sand Before Wastage"
                value={`${calculation.baseSandKg.toFixed(
                  2
                )} kg`}
              />
              ...
              <ResultRow
                label="Sand Before Wastage"
                value={`${calculation.baseSandTonnes.toFixed(
                  3
                )} tonnes`}
              />

              <ResultRow
                label={`Sand Wastage (${wastage || 0}%)`}
                value={`+ ${calculation.wastageKg.toFixed(
                  2
                )} kg`}
              />
              ...
              <ResultRow
                label="Sand Wastage"
                value={`+ ${calculation.wastageTonnes.toFixed(
                  3
                )} tonnes`}
              />
              ...
              <div className="border-t pt-4">
                ...
                <ResultRow
                  label="Final Sand Required"
                  value={`${calculation.finalKg.toFixed(
                    2
                  )} kg`}
                  bold
                />
                ...
                <div className="mt-3">
                  ...
                  <ResultRow
                    label="Final Sand Quantity"
                    value={`${calculation.finalTonnes.toFixed(
                      3
                    )} tonnes`}
                    bold
                  />
              ...
              <div className="border-t pt-4">
                ...
                <ResultRow
                  label="Final Sand Volume"
                  value={`${calculation.finalVolumeM3.toFixed(
                    4
                  )} m³`}
                  bold
                />
                ...
                <div className="mt-3">
                  ...
                  <ResultRow
                    label="Final Sand Volume"
                    value={`${calculation.finalVolumeFt3.toFixed(
                      4
                    )} cu ft`}
                  />
